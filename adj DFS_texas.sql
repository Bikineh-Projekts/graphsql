CREATE OR REPLACE FUNCTION "Road networks".recursive_dfs_adj(
    current_node INT,
    target INT,
    max_depth INT,
    current_depth INT,
...
BEGIN
    ...
    LOOP
        PERFORM "Road networks".recursive_dfs_adj(
...
END;
$$ LANGUAGE plpgsql;
CREATE OR REPLACE FUNCTION "Road networks".find_shortest_path(
    source INT,
    target INT,
    max_depth INT
)
...
BEGIN
    ...
    PERFORM "Road networks".recursive_dfs_adj(source, target, max_depth + 1, 1, ARRAY[source]);
